...
{
    public class UnitOfWork01<TContext> : IUnitOfWork01<TContext>, IDisposable
         where TContext : DbContext, new()
    {
        ...
        public GenericRepository01<T> GenericRepository01<T>() where T : class
        {
            ...
            {
                var repositoryType = typeof(GenericRepository01<T>);
                var repositoryInstance = Activator.CreateInstance(repositoryType.MakeGenericType(typeof(T)), _context);
                _repositories.Add(type, repositoryInstance);
            }
            return (GenericRepository01<T>)_repositories[type];
        }
    }
}